...
public class Pool : MonoBehaviour
{
	...
	//Sending the wanted object to whoever call this function with position, rotation does it need to be children and active it
    public GameObject Object (GameObject Need,Vector3 Position,Quaternion Rotation,bool Active = true)
    {
